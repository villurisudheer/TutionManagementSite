# START HERE — Aacharya Tuition Manager v4 + Existing Parent Portal Extension
...
The main improvement in v4 is the Excel system: the old plain workbook is replaced by a professional 27-sheet master workbook with dashboards, Student 360, finance analytics, attendance/monthly analysis, dues, payment intelligence, performance summaries, admissions, data-quality checks and a data dictionary. Existing tuition-manager records and workflows remain compatible.

## What was changed in v3

The core v4 manager was left intact except for:
...
On approval, the extension securely creates the official payment in v4. That payment then appears in the main Tuition Manager and its Excel master workbook.
