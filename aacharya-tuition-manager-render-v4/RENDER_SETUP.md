# Render Setup — Integrated v4 + Parent Portal Extension 1.0
...
## If your existing v4 service already contains real data

Do **not** delete the existing service or its disk.

1. Push this integrated project to the same GitHub repository your current v4 service already deploys from.
...
9. Confirm the payment appears in the main v4 Payments section and in `Aacharya_Tuition_Master_v4.xlsx`.
