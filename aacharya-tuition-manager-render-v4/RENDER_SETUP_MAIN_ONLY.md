...
Student-Intake-Project/
  aacharya-tuition-manager-render-v4/
    package.json
    server.js
    public/
```
...
```text
Root Directory: aacharya-tuition-manager-render-v4
...
You normally do not need Render Shell to retrieve it. Log in to `/admin`, open **Settings & Excel**, and click **Download Aacharya_Tuition_Master_v4.xlsx**.
