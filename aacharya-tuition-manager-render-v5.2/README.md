...
# Aacharya Tuition Manager v5.2 — Render + Comprehensive Excel Intelligence
...
`DATA_DIR/Aacharya_Tuition_Master_v5.xlsx`

On Render with the recommended persistent disk:

`/var/data/Aacharya_Tuition_Master_v5.xlsx`
...
The admin can download the current workbook from **Settings & Excel → Download Aacharya_Tuition_Master_v5.xlsx**.
