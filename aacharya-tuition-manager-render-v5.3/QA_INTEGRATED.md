...
The combined project was checked after integrating the Parent Portal into the user's uploaded v4 source.

## Passed

- Main v4 JavaScript syntax checks
...
3. Admission accepted in main v4
...
12. Parent Portal calls the protected v4 bridge
13. Official payment appears in main v4
