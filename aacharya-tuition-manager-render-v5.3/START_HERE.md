# START HERE — Aacharya Tuition Manager v5.3.0
...
The database filename is unchanged (`aacharya_tuition.sqlite`), so existing data remains compatible when the same persistent disk is retained. The generated workbook filename becomes `Aacharya_Tuition_Master_v5_3.xlsx`.
