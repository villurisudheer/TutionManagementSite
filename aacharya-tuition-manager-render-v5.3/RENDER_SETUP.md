# Render Setup — Integrated v5.3 + Parent Portal Extension 1.0
...
9. Confirm the payment appears in the main v5 Payments section and in `Aacharya_Tuition_Master_v5_3.xlsx`.
