# Render Setup — Integrated v3 + Parent Portal Extension 1.0
...
## If your existing v3 service already contains real data

Do **not** delete the existing service or its disk.

1. Push this integrated project to the same GitHub repository your current v3 service already deploys from.
...
9. Confirm the payment appears in the main v3 Payments section and in `Aacharya_Tuition_Master.xlsx`.
